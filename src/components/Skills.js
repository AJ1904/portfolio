...
const Skills = () => {
  return (
      ...
      <>
      <br />
      <h4 className="leftalign">👨‍💻 Programming and Markup Languages</h4>
...
<h4 className="leftalign">🧰 Frameworks, Libraries and Analytics</h4>
<p className="leftalign">
...
<h4 className="leftalign">🗄️ Databases and Cloud Hosting</h4>
<p className="leftalign">
...
<h4 className="leftalign">💻 Software, Tools and OS</h4>
<p className="leftalign">
