...
const Home = () => {
  return (
    ...
    <div class="social-icons">
        <a href="https://www.linkedin.com/in/ayushrijain" target="_blank" class="social-icon"><i><img src={linkedinlogo}></img></i></a>
        <a href="https://github.com/AJ1904" target="_blank" class="social-icon"><img src={githublogo}></img></a>
        <a href="mailto:ayushrijain19@gmail.com" target="_blank" class="social-icon"><img src={gmaillogo}></img></a>
        <a href="https://grad.tamu.edu/aggie-life/aggie-voice/ayushri-jain" target="_blank" class="social-icon"><img src={tamulogo}></img></a>
